...
export default function DetailPanel() {
  ...
  if (!item) {
    return (
      <aside className="side bg-crm-panel border-l border-crm-line grid grid-rows-[auto_minmax(0,1fr)] min-w-0 max-lg:fixed max-lg:right-0 max-lg:top-0 max-lg:bottom-0 max-lg:w-[min(360px,100vw)] max-lg:shadow-[0_12px_30px_rgba(15,23,42,.08)] max-lg:translate-x-full max-lg:transition-transform max-lg:duration-200 max-lg:z-[5]">
        <div className="side-head p-4 border-b border-crm-line flex justify-between items-center gap-[10px]">
  ...
  return (
    <aside className="side bg-crm-panel border-l border-crm-line grid grid-rows-[auto_minmax(0,1fr)] min-w-0 max-lg:fixed max-lg:right-0 max-lg:top-0 max-lg:bottom-0 max-lg:w-[min(360px,100vw)] max-lg:shadow-[0_12px_30px_rgba(15,23,42,.08)] max-lg:translate-x-0 max-lg:transition-transform max-lg:duration-200 max-lg:z-[5]">
      <div className="side-head p-4 border-b border-crm-line flex justify-between items-center gap-[10px]">
