...
export default function OnboardOrganisationPage() {
  ...
  return (
    <div className="h-dvh grid items-start bg-crm-bg p-6 overflow-y-auto">
      <div className="w-full max-w-[520px] rounded-[20px] overflow-hidden shadow-[0_12px_30px_rgba(15,23,42,.08)] bg-crm-panel animate-[loginRise_0.45s_cubic-bezier(.16,1,.3,1)_both] my-auto">
