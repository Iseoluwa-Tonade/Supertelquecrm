...
export default function CompaniesPage() {
  ...
  return (
    <div className="h-dvh grid items-start bg-crm-bg p-6 max-md:p-0 max-md:items-stretch overflow-y-auto">
      <div className="w-full max-w-[540px] rounded-[20px] overflow-hidden shadow-[0_12px_30px_rgba(15,23,42,.08)] bg-crm-panel animate-[loginRise_0.45s_cubic-bezier(.16,1,.3,1)_both] p-[46px_40px] max-md:p-0 max-md:rounded-none max-md:shadow-none max-md:min-h-dvh max-md:overflow-auto my-auto">
