...
-- 9. Project creation support -------------------------------------------------
-- Ensures the crm_board_items table exists with every column used by the
-- "New project" form (projects + tasks are stored here), RLS is enabled, and
-- managers/admins can insert/update/delete projects. Idempotent.
